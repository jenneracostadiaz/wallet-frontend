<div
    class="p-6 lg:p-8 bg-gray-800 bg-gradient-to-bl from-gray-700/50 via-transparent border-b border-gray-200 border-gray-700">
    ...
    <div>
        ...
        <p class="mt-4 text-sm">
            <a href="https://laravel.com/docs" class="inline-flex items-center font-semibold text-indigo-300">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-1 size-5 fill-indigo-200">
